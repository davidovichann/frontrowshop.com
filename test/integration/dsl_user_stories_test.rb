...
class DslUserStoriesTest < ActionDispatch::IntegrationTest
  fixtures :products
   ...
   def setup
     LineItem.delete_all
     Order.delete_all
     @coat_clothing = products(:coat)
     @skirt_clothing = products(:two)
   end 
   ...
   def test_buying_a_product
     ...
     dave.buys_a @coat_clothing
     dave.has_a_cart_containing @coat_clothing
     dave.checks_out DAVES_DETAILS
     dave.is_viewing "index"
     check_for_order DAVES_DETAILS, @coat_clothing
   end
   ...
   def test_two_people_buying
     dave = regular_user
         mike = regular_user
     dave.buys_a @coat_clothing
         mike.buys_a @skirt_clothing
     dave.has_a_cart_containing @coat_clothing
     dave.checks_out DAVES_DETAILS
         mike.has_a_cart_containing @skirt_clothing
     check_for_order DAVES_DETAILS, @coat_clothing
         mike.checks_out MIKES_DETAILS
         check_for_order MIKES_DETAILS, @skirt_clothing
   end
